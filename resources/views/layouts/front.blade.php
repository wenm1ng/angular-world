...
<div class="mobile-wrap center">
    <div class="title">
        ...
        <h6>
            <a href="{{ url('/lotteries') }}" class="a-list">
                获奖<br/>名单
            </a>
            <a href="{{ url('/center') }}" class="a-pers">
                个人<br/>中心
            </a>
        </h6>
        <ul>
            <li><i></i><a href="{{ url('/') }}">竞猜狂欢</a></li>
            <li><i></i><a href="{{ url('/rank') }}">谁是预言帝</a></li>
            <li><i></i><a href="{{ url('/talk') }}">吐槽一刻</a></li>
        </ul>
    </div>
    <main>
        @yield('content')
