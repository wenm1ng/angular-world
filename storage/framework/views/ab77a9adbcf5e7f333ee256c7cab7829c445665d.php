<!DOCTYPE html>
<html lang="<?php echo e(app()->getLocale()); ?>" ng-app="wcapp">
<head>
    <meta charset="utf-8">
    ...
    <link href="<?php echo e(asset('css/themes/base/jquery-ui.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('css/gt.css')); ?>" rel="stylesheet">
</head>
<body>
<div class="container">
    <div class="navbar navbar-default navbar-fixed-top notprint">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li><a href="<?php echo e(url('/admin/games')); ?>">比赛场次</a></li>
                <li><a href="<?php echo e(url('/admin/teams')); ?>">球队设置</a></li>
                <li><a href="<?php echo e(url('/admin/users')); ?>">用户列表</a></li>
                <li><a href="<?php echo e(url('/admin/talks')); ?>">留言管理</a></li>
            </ul>
        </div>
    </div>
</div>
